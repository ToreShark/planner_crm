...
Верни JSON объект WeeklyPlanOutput с:
- Фокусом недели и 3 стратегическими намерениями
- Задачами по категориям (work, tech, marketing, health, personal)
- Контрольными точками по дням (Пн-Вс) с конкретными задачами и временными блоками
- Рисками и планами обхода`;
